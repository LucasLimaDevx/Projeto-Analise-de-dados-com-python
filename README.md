...
Para resolver, utilize o Python.
...
Dica: Para separar os dados, siga o que você fez no Projeto 1, crie duas listas de valores (com e sem problemas cardíacos) e em seguida calcule as medidas para cada lista.  Vamos treinar escrita de código!

Dica: Use a biblioteca matplotlib para criar o boxplot. Se não souber, leia aqui: https://www.geeksforgeeks.org/box-plot-in-python-using-matplotlib/

Medidas de posição obtidos:

Boxplot:

O boxpçot gerando nos mostra que um grupo de pessoas com o IMC alto, tendem a ter mais problemas cardíacos do que o grupo com IMC baixo.
...
O conceito de módulo (valor absoluto) pode ser útil na análise do IMC? Como?
